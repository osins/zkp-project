...
pub use circuits::{
    AgeVerificationCircuit, BalanceProofCircuit, MerkleProofCircuit, RangeProofCircuit,
    SquareCircuit, VotingCircuit,
};
pub use simple_adapter::{SimpleProofSystem, SimpleValue};
pub use wasm_bindings::{
    wasm_generate_age_proof, wasm_generate_balance_proof, wasm_verify_age_proof,
...
pub fn wasm_generate_proof(x: u32) -> Vec<u8> {
    ...
    let circuit = circuits::SquareCircuit {
        x: Some((x as u64).into()),
    };
